...
class Usuario(Base):
    ...
    # SPIKE SSO UTalca: identificador que devuelve huemul.utalca.cl tras autenticar.
    # Nullable porque los usuarios locales (login por contraseña) no lo necesitan;
    # único porque un RUT identifica a una sola persona.
